...
this.game.gameInstances.Controller.userData.FeatHandler.heroFeatSlots := New GameObjectStructure(this.game.gameInstances.Controller.userData.FeatHandler,"Dict", [0x40])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.def.SeatID := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.def,"Int", [0x210])
...
this.game.gameInstances.Controller.userData.inited := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Char", [0x2e8])
...
this.game.gameInstances.Controller.userData.redRubies := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x2c4])
this.game.gameInstances.Controller.userData.redRubiesSpent := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x2c8])
...
this.game.gameInstances.Controller.userData.StatHandler.BlackViperTotalGems := New GameObjectStructure(this.game.gameInstances.Controller.userData.StatHandler,"Int", [0x300])
this.game.gameInstances.Controller.userData.StatHandler.BrivSteelbonesStacks := New GameObjectStructure(this.game.gameInstances.Controller.userData.StatHandler,"Int", [0x368])
this.game.gameInstances.Controller.userData.StatHandler.BrivSprintStacks := New GameObjectStructure(this.game.gameInstances.Controller.userData.StatHandler,"Int", [0x36c])
this.game.gameInstances.Controller.userData.StatHandler.Resets := New GameObjectStructure(this.game.gameInstances.Controller.userData.StatHandler,"Int", [0xc8])
...
this.game.gameInstances.Controller.userData.TrialsHandler.pendingUnclaimedCampaignID := New GameObjectStructure(this.game.gameInstances.Controller.userData.TrialsHandler,"Int", [0x138])
...
this.game.gameInstances.ActiveCampaignData.currentRules.MonsterDamageModifier := New GameObjectStructure(this.game.gameInstances.ActiveCampaignData.currentRules,"Double", [0x3d0])
...
this.game.gameInstances.ActiveCampaignData.currentRules.ForceUseHeroesInfo := New GameObjectStructure(this.game.gameInstances.ActiveCampaignData.currentRules,"Int", [0x120])
this.game.gameInstances.ActiveCampaignData.currentRules.ForceUseHeroesInfo.heroIds := New GameObjectStructure(this.game.gameInstances.ActiveCampaignData.currentRules.ForceUseHeroesInfo,"List", [0x38])
this.game.gameInstances.ActiveCampaignData.currentRules.ForceUseHeroesInfo.heroIds._CollectionValType := "System.Int32"
...
this.game.gameInstances.Controller.formation.slots.heroAlive := New GameObjectStructure(this.game.gameInstances.Controller.formation.slots,"Char", [0x269])
this.game.gameInstances.Controller.formation.slots.slotDef := New GameObjectStructure(this.game.gameInstances.Controller.formation.slots,"Int", [0x138])
...
this.game.gameInstances.Screen.uiController.bossPowerupPopup := New GameObjectStructure(this.game.gameInstances.Screen.uiController,"Int", [0x110])
...
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes.levelUpInfoHandler := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes,"Int", [0x400])
...
this.game.gameInstances.Screen.uiController.topBar.dpsMenuBox.menuBox := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar.dpsMenuBox,"Int", [0x360])
this.game.gameInstances.Screen.uiController.topBar.dpsMenuBox.menuBox.numberOfUnclaimedQuests := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar.dpsMenuBox.menuBox,"Int", [0x3dc])
